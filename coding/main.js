import { DRACOLoader } from "/storybook/libs/three.js-r132/examples/jsm/loaders/DRACOLoader.js";
import { GLTFLoader } from "/storybook/libs/three.js-r132/examples/jsm/loaders/GLTFLoader.js";
...
const initializeMindAR = () => {
  return new window.MINDAR.IMAGE.MindARThree({
    ...
    imageTargetSrc: '/storybook/assets/targets/page1.mind',
  });
};
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  '/storybook/assets/models/page1/scene1.glb', 
  { x: 0.04, y: 0.04, z: 0.04 }, // Scale for page1
  { x: 0, y: -0.4, z: 0 }        // Position for page1
);
    const page2Model = await loadModel('/storybook/assets/models/page2/Stage2t.glb', 
  { x: 0.08, y: 0.08, z: 0.08 }, // Scale for page2
  { x: 0, y: -0.4, z: 0 }        // Position for page2
);
    const page3Model = await loadModel('/storybook/assets/models/page3/Stage3t.glb', 
  { x: 0.08, y: 0.08, z: 0.08 }, // Scale for page3
  { x: 0, y: -0.4, z: 0 }        // Position for page3
);
    const page4Model = await loadModel('/storybook/assets/models/page4/Stage4t.glb', 
  { x: 0.04, y: 0.04, z: 0.04 }, // Scale for page4
  { x: -0.1, y: -0.4, z: -1.0 }        // Position for page4
);

const page5Model = await loadModel('/storybook/assets/models/page5/Stage5t.glb', 
  { x: 0.04, y: 0.04, z: 0.04 }, // Scale for page5
  { x: 0, y: -0.4, z: 0 }        // Position for page5
);

const page6Model = await loadModel('/storybook/assets/models/page6/Stage6t.glb', 
  { x: 0.06, y: 0.06, z: 0.06 }, // Scale for page6
  { x: 0, y: -1.0, z: 0 }        // Position for page6
);

const page7Model = await loadModel('/storybook/assets/models/page7/Stage7t.glb', 
  { x: 0.02, y: 0.02, z: 0.02 }, // Scale for page7
  { x: 0, y: -0.6, z: 0 }        // Position for page7
);

const page8Model = await loadModel('/storybook/assets/models/page8/Stage8t.glb', 
  { x: 0.02, y: 0.02, z: 0.02 }, // Scale for page8
  { x: 0, y: -0.5, z: 0 }        // Position for page8
);

const page9Model = await loadModel('/storybook/assets/models/page9/Stage9t.glb', 
  { x: 0.02, y: 0.02, z: 0.02 }, // Scale for page9
  { x: 0, y: -0.3, z: 0 }        // Position for page9
);

const page10Model = await loadModel('/storybook/assets/models/page10/Stage10t.glb', 
  { x: 0.06, y: 0.06, z: 0.06 }, // Scale for page10
  { x: 0, y: -0.4, z: 0 }        // Position for page10
);

const page1Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page1Model, 0, '/storybook/assets/audio/english/page1.mp3');

     const page2Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page2Model, 1,  '/storybook/assets/audio/english/page2.mp3');

     const page3Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page3Model, 2,  '/storybook/assets/audio/english/page3.mp3');

     const page4Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page4Model, 3,  '/storybook/assets/audio/english/page4.mp3');

     const page5Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page5Model, 4,  '/storybook/assets/audio/english/page5.mp3');

     const page6Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page6Model, 5,  '/storybook/assets/audio/english/page6.mp3');

     const page7Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page7Model, 6,  '/storybook/assets/audio/english/page7.mp3');

     const page8Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page8Model, 7,  '/storybook/assets/audio/english/page8.mp3');

     const page9Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page9Model, 8,  '/storybook/assets/audio/english/page9.mp3');

     const page10Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page10Model, 9,  '/storybook/assets/audio/english/page10.mp3');
