...
const initializeMindAR = () => {
  return new window.MINDAR.IMAGE.MindARThree({
    ...
    imageTargetSrc: '/storybook/assets/targets/group10.mind',
  });
};
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  '/storybook/assets/models/scene1.glb', 
  { x: 0.12, y: 0.12, z: 0.12 }, // Scale for page1
  { x: 0, y: -0.4, z: 0 }        // Position for page1
);
    const page2Model = await loadModel('/storybook/assets/models/scene2.glb', 
  { x: 0.16, y: 0.16, z: 0.16 }, // Scale for page2
  { x: 0, y: -0.4, z: 0 }        // Position for page2
);
    const page3Model = await loadModel('/storybook/assets/models/scene3.glb', 
  { x: 0.16, y: 0.16, z: 0.16 }, // Scale for page3
  { x: 0, y: -0.4, z: 0 }        // Position for page3
);
    const page4Model = await loadModel('/storybook/assets/models/scene4.glb', 
  { x: 0.12, y: 0.12, z: 0.12 }, // Scale for page4
  { x: -0.1, y: -0.4, z: -1.0 }        // Position for page4
);

const page5Model = await loadModel('/storybook/assets/models/scene5.glb', 
  { x: 0.12, y: 0.12, z: 0.12 }, // Scale for page5
  { x: 0, y: -0.4, z: 0 }        // Position for page5
);

const page6Model = await loadModel('/storybook/assets/models/scene6.glb', 
  { x: 0.18, y: 0.18, z: 0.18 }, // Scale for page6
  { x: 0, y: -1.0, z: 0 }        // Position for page6
);

const page7Model = await loadModel('/storybook/assets/models/scene7.glb', 
  { x: 0.06, y: 0.06, z: 0.06 }, // Scale for page7
  { x: 0, y: -0.6, z: 0 }        // Position for page7
);

const page8Model = await loadModel('/storybook/assets/models/scene8.glb', 
  { x: 0.06, y: 0.06, z: 0.06 }, // Scale for page8
  { x: 0, y: -0.5, z: 0 }        // Position for page8
);

const page9Model = await loadModel('/storybook/assets/models/scene9.glb', 
  { x: 0.06, y: 0.06, z: 0.06 }, // Scale for page9
  { x: 0, y: -0.3, z: 0 }        // Position for page9
);

const page10Model = await loadModel('/storybook/assets/models/scene10.glb', 
  { x: 0.18, y: 0.18, z: 0.18 }, // Scale for page10
  { x: 0, y: -0.4, z: 0 }        // Position for page10
);

const page1Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page1Model, 0, '/storybook/assets/audio/malay/page1.mp3');

     const page2Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page2Model, 1,  '/storybook/assets/audio/malay/page2.mp3');

     const page3Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page3Model, 2,  '/storybook/assets/audio/malay/page3.mp3');

     const page4Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page4Model, 3,  '/storybook/assets/audio/malay/page4.mp3');

     const page5Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page5Model, 4,  '/storybook/assets/audio/malay/page5.mp3');

     const page6Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page6Model, 5,  '/storybook/assets/audio/malay/page6.mp3');

     const page7Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page7Model, 6,  '/storybook/assets/audio/malay/page7.mp3');

     const page8Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page8Model, 7,  '/storybook/assets/audio/malay/page8.mp3');

     const page9Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page9Model, 8,  '/storybook/assets/audio/malay/page9.mp3');

     const page10Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page10Model, 9,  '/storybook/assets/audio/malay/page10.mp3');
